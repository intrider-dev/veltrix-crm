...
The 2026-07-22 measurements passed bundle, Lighthouse score/accessibility, CLS, interaction, DOM, scrolling, browser heap/retention, search p95, error-rate, startup, idle-app, and combined-memory targets. Three budgets remain red after two additional SQL optimization iterations: simulated mobile LCP was 2.76 s against 2.0 s, median 50-VU read p95 was 189.09 ms against 150 ms, and write p95 was 283.19 ms against 250 ms. Full method and qualifications are in [`PERFORMANCE.md`](PERFORMANCE.md).
